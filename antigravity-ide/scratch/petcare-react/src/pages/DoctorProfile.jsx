              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <span className="px-2.5 py-0.5 rounded-full bg-emerald-600 text-white font-black text-[6px] uppercase tracking-wider">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <h3 className="font-headline-sm font-bold text-lg border-b border-outline-variant/30 pb-2 mb-4 flex items-center justify-between">
                ...
                <span className={`text-xs px-2.5 py-0.5 rounded-full font-bold uppercase border ${isSuspended
              ...
              <div>
                ...
                <div className={`px-3 py-2 rounded-lg text-xs font-bold flex items-center gap-2 border ${isSuspended
