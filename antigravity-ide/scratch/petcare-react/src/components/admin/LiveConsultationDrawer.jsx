      ...
      <div className="w-full max-w-xl bg-white h-full shadow-2xl border-l border-outline-variant/30 flex flex-col justify-between overflow-y-auto">
        <div>
          ...
          <div className="p-6 border-b border-outline-variant/20 flex items-center justify-between bg-surface-container-low">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface-variant">Session ID: {consultation.id}</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="rounded-2xl bg-[#121c2d] p-4 text-white relative overflow-hidden shadow-md">
              <div className="flex items-center justify-between text-xs mb-3 border-b border-white/10 pb-2">
                <span className="flex items-center gap-2 font-semibold">
                  <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
                  <span>WebRTC P2P Stream Active</span>
                </span>
                <span className="font-mono text-emerald-300">00:14:32</span>
              </div>

              <div className="grid grid-cols-2 gap-3 mb-3">
                {/* Vet Feed Tile */}
                <div className="bg-white/10 rounded-xl p-3 relative h-28 flex flex-col justify-between border border-white/10">
                  <div className="flex items-center justify-between text-[0.625rem] text-white/80">
                    <span>{consultation.vet}</span>
                    <span className="text-emerald-400">Audio/Mic ON</span>
                  </div>
                ...
                <div className="bg-white/10 rounded-xl p-3 relative h-28 flex flex-col justify-between border border-white/10">
                  <div className="flex items-center justify-between text-[0.625rem] text-white/80">
                    <span>{consultation.owner} ({consultation.pet})</span>
                    <span className="text-emerald-400">Audio/Mic ON</span>
                  </div>
                  <div className="text-center font-bold text-xs text-white/70">
                    Patient/Owner Feed
              ...
              {/* Network Stats */}
              <div className="grid grid-cols-3 gap-2 text-center text-[0.6875rem] bg-white/5 rounded-xl p-2 font-mono">
                <div>
        ...
        <div className="p-4 border-t border-outline-variant/20 bg-surface-container-low flex items-center gap-3">
          <button
            ...
            className="flex-1 py-2.5 bg-primary text-white rounded-xl text-xs font-bold hover:bg-primary-container transition-colors shadow-sm flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="px-4 py-2.5 bg-white border border-outline-variant/30 text-on-surface rounded-xl text-xs font-bold hover:bg-surface-container transition-colors"
          >
            Export Log
          </button>
        </div>
